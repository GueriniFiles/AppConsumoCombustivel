...
> um aplicativo que calcula quanto é gasto em gasolina.

## 📱 Descrição

O app permite a inserção do nome, placa, distancia percorrida, consumo médio, e preço de combustivel do veiculo, e imprime o resultado do calculo.
